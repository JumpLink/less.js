...
tree.functions = {
   ...
   */
    ...
    */ 
    alpha: function (color, amount) {
        var hsl = color.toHSL();
        hsl.a = clamp(hsl.a*amount.value);
        return hsla(hsl);
    },
    fade: function (color, amount) {
        amount.value = weight.value*100;
     ...
     */
    background_gradient: function(type, from_position, to_position) {
        var css = "";
        var direction = "";
        type = type.value;
        ...
        {
            css += "background-image: -webkit-"+type+"-gradient(";
            switch(direction) {
                case "vertical":
                    css += " top";
                break;
        ...
        {
            css += "background-image: -o-"+type+"-gradient(";
            switch(direction) {
                case "vertical":
                    css += " top";
                break;
        ...
        /* IE10+ (most like W3C)*/
        {
            css += "background-image: -ms-"+type+"-gradient(";
            switch(direction) {
                case "vertical":
                    css += " top";
                break;
        ...
        /* IE6-9 */
        {
            ...
            css += " startColorstr='"+arguments[3].color+"'"
    ...
    color_stop: function (position, color) {
